...
import com.zhenhappy.ems.manager.dao.ColFieldInfoDao;
...
/**
 * Created by wangxd on 2017-04-18.
 */
@Repository
public class ColFieldInfoDaoImp extends BaseDaoHibernateImp<ColFieldInfo> implements ColFieldInfoDao {
